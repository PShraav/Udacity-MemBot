...
ChatLogic::ChatLogic()
{
    ...
    //Task 5 - new local instance created so this is no longer required
...
ChatLogic::~ChatLogic()
{
    ...
    //Task 3 - _nodes is now a unique ptr so delete not required
    // delete all nodes
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        //// STUDENT CODE
                        ////
                        //Task 3 - changes to adapt node as unique pointer
    ...
    //Task 5 - creat new  local ChatBot instance
